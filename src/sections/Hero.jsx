...
const Hero = () => {
  return (
    <motion.section
      id="about"
      className="pb-[100px] pt-[80px] flex justify-center relative ease-out scroll-mt-40 widescreen:section-min-height  tallscreen:section-min-height bg-[url('./white-tech.jpg')] bg-cover"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    >
      <motion.article
